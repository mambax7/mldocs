...
define('_AM_MLDOCS_DEPARTMENT_SERVER_EMAILADDRESS', 'R&eacute;pondre à l\'Adresse Email');
...
define('_AM_MLDOCS_DB_NOUPDATE', 'Votre Base de Donn&eacute;es est à jour. Aucune mis à jour n\'est n&eacute;c&eacute;ssaire.');
...
define('_AM_MLDOCS_MSG_UPDATE_ROLE', 'le role de permissions %s a &eacute;t&eacute; mis à jour.');
...
define('_AM_MLDOCS_TEXT_SELECT_DEPTUSERDEF', 'Affecter un d&eacute;partement à l\'utilisateur');
