...
/**
 * mldocsSavedSearch class
 *
 * @author Eric Juden <ericj@epcusa.com> 
 * @access public
 * @package mldocs
 */ 
class mldocsSavedSearch extends XoopsObject {
    function mldocsSavedSearch($id = null) 
	{
...
/**
 * mldocsSavedSearchHandler class
 *
 * SavedSearch Handler for mldocsSavedSearch class
 *
 * @author Eric Juden <ericj@epcusa.com> &
 * @access public
 * @package mldocs
...
class mldocsSavedSearchHandler extends mldocsBaseObjectHandler {
	/**
     * Name of child class
     * 
     * @var	string
     * @access	private
     */
	var $classname = 'mldocssavedsearch';
     ...
     * @access private
     */
     var $_dbtable = 'mldocs_saved_searches';
     ...
     */	
	function mldocsSavedSearchHandler(&$db)
	{
	    parent::init($db);
    }
