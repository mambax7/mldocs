...
/**
 * mldocsNotification class
 *
 * @author Eric Juden <ericj@epcusa.com> 
 * @access public
 * @package mldocs
 */ 
class mldocsNotification extends XoopsObject {
    function mldocsNotification($id = null) 
	{
...
/**
 * mldocsNotificationHandler class
 *
 * Notification Handler for mldocsNotification class
 *
 * @author Eric Juden <ericj@epcusa.com> &
 * @access public
 * @package mldocs
...
class mldocsNotificationHandler extends mldocsBaseObjectHandler {
	/**
     * Name of child class
     * 
     * @var	string
     * @access	private
     */
	var $classname = 'mldocsnotification';
     ...
     * @access private
     */
     var $_dbtable = 'mldocs_notifications';
     ...
     */	
	function mldocsNotificationHandler(&$db)
	{
	    parent::init($db);
    }
