...
Class mldocsBaseObjectHandler extends XoopsObjectHandler {
    /**
     * Database connection
     * 
     * @var	object
   ...
   /**
    * create a new  object
    * @return object {@link mldocsBaseObject}
    * @access public
    */
    function &create()
    {
    ...
    */
    ...
    /**
	 * Assign a value to 1 field for archives matching a set of conditions
	 * 
	 * @param object $criteria {@link CriteriaElement} 
